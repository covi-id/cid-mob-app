...
export default function (props) {
   return (
      <Svg width={width} height={width} viewBox="0 0 375 374" fill="none" {...props}>
         ...
         />
         <Path
            d="M375 187V0l-55 54.355C353.976 87.87 375 135.918 375 187z"
            fill="#27066B"
         />
         <Path
            d="M375 187.001c0-51.566-21.016-98.965-55-132.645L187 187h188z"
            fill="#2E0382"
         />
         ...
         />
         <Path
            d="M375 187v187l-55-54.355c33.976-33.515 55-81.563 55-132.645z"
            fill="#210854"
         />
         <Path
            d="M375 186.999c0 51.566-21.016 98.965-55 132.646L187 186.999h188z"
            fill="#2E0382"
         />
